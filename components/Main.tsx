      ...
      <section className="bg-AzulP relative lg:block h-[100vh]">
        <div className="h-full">
          <article className="h-full flex">
            <div className="h-full bgMain1 mt-14 flex flex-col justify-center px-2 lg:px-0 lg:mt-0 lg:pl-40 lg:w-1/2">
              <h1 className="font-Barlow text-white uppercase text-center font-bold text-3xl lg:text-left lg:text-8xl">
                Family logging & forestry company
              </h1>
              ...
              <p className="mt-6 font-Jost text-white text-center lg:text-lg lg:text-left lg:pr-8">
                ...
                Veritatis assumenda, ad, accusantium error expedita saepe cumque
                eligendi sed dolore repellendus eius quod quaerat voluptatum
                rerum tempora! Aliquam unde accusantium consequatur?
              </p>
